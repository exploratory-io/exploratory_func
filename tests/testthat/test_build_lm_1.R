...
test_that("Linear Regression with test rate", {
  ...
  suppressWarnings({
    ...
    if (requireNamespace("mmpf", quietly = TRUE)) { # mmpf is required for permutation importance and partial dependence
...
test_that("Logistic Regression with test_rate", {
  ...
  suppressWarnings({
    ...
    expected_cols <- c("Term", "Coefficient", "Std Error", "z Value", "P Value", "Conf High", "Conf Low", "Odds Ratio", "Base Level")
