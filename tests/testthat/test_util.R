...
test_that("week", {
  # Test Data:
  # [1] "2019-01-01" "2019-01-16" "2019-01-31" "2019-02-15" "2019-03-02"
  # [6] "2019-03-17" "2019-04-01" "2019-04-16" "2019-05-01" "2019-05-16"
  # [11] "2019-05-31" "2019-06-15" "2019-06-30" "2019-07-15" "2019-07-30"
  # [16] "2019-08-14" "2019-08-29" "2019-09-13" "2019-09-28" "2019-10-13"
  # [21] "2019-10-28" "2019-11-12" "2019-11-27" "2019-12-12" "2019-12-27"
  dates<- seq(lubridate::ymd(20190101), lubridate::ymd(20191231), by='15 days')
  expect_equal(exploratory::week(dates), c(1,3,5,7,9,11,13,16,18,20,22,24,26,28,31,33,35,37,39,41,43,46,48,50,52))
  expect_equal(exploratory::week(dates, unit="month"), c(1,3,5,3,1,4,1,3,1,3,5,3,6,3,5,3,5,2,4,3,5,3,5,2,4))
  expect_equal(exploratory::week(dates, unit="quarter"), c(1,3,5,7,9,11,1,4,6,8,10,12,14,3,6,8,10,12,14,2,4,7,9,11,13))
