...
test_that("test build_lm summary output ", {
  ...
  expect_equal(colnames(trial), c("source.data", ".test_index", "model", ".model_meta_data"))
...
test_that("test name conflict avoid", {
  ...
  expect_equal(colnames(lm_model), c("estimate.group", "model.group", "model.group1", "source.data", ".test_index", "model", ".model_meta_data"))
