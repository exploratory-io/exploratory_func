...
test_that("test build_glm summary output ", {
  ...
  expect_equal(colnames(trial), c(".test_index", "source.data", "model", ".model_meta_data"))
...
test_that("test build_glm with keep.source FALSE ", {
  ...
  expect_equal(colnames(trial), c(".test_index", "model", ".model_meta_data"))
})
...
test_that("test name conflict avoid", {
  ...
  expect_equal(colnames(glm_model), c("estimate.group", "model.group", "model.group1", "source.data", ".test_index", "model", ".model_meta_data"))
