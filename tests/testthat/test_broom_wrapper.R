...
test_that("test data frame prediction by xgboost", {
  train_data <- structure(list(age = c(66L, 44L, 21L, 78L, 28L, 40L, 61L, 60L,
                              ...
                              education = c("7th-8th", "Masters", "Some-college", "Bachelors",
                                            "7th-8th", "Prof-school", "HS-grad", "Some-college", "Some-college",
                                            "HS-grad", "Some-college", "Masters", "HS-grad", "Some-college",
                                            "HS-grad", "Bachelors", "Prof-school", "Some-college", "11th",
                                            "Some-college"),
                              `education-num` = c("4", "14", NA, "13",
                                                  "4", NA, "9", NA, NA, "15", NA, "14", "9", NA, "9", "13",
                                                  "9", NA, "7", NA),
                              `marital-status` = c("Widowed", "Divorced",
                                                   "Never-married", "Married-civ-spouse", "Divorced", "Never-married",
                                                   "Husband", "Widowed", "Married-civ-spouse", "Married-civ-spouse",
                                                   "Married-civ-spouse", "Never-married", "Married-civ-spouse",
                                                   "Married-civ-spouse", "Married-civ-spouse", "Divorced", "Never-married",
                              ...
                              occupation = c("Other-service", "Exec-managerial", "Sales",
                                             ...
                                             "Transport-moving", "Tech-support", "Protective-serv", "Prof-specialty",
                                             "Craft-repair", "Exec-managerial", "Machine-op-inspct", "Exec-managerial",
                                             "Other-service", "Farming-fishing", "Adm-clerical", "Craft-repair"),
                              relationship = c("Not-in-family", "Not-in-family", "Not-in-family",
                                               "Husband", "Unmarried", "Not-in-family", "Husband", "Unmarried",
                                               "Husband", "Wife", "Husband", "Not-in-family", "Husband",
                              ...
                              `native-country` = c("United-States", "United-States", "United-States", "United-States", "United-States",
                                                   "United-States", "Mexico", "Mexico", "United-States", "Mexico",
  ...
  test_data <- structure(list(age = c(29L, 42L, 41L, 28L, 26L, 40L, 25L, 19L,
                                      40L, 29L),
                              workclass = c("Private", "Private", "Private", "Local-gov",
                              ...
                              race = c("White", "White", "Black", "White", "White", "White", "Black", "White",
                                       "White", "White"
                                       ),
