...
test_that("ttest power analysis density plot data generation", {
  ...
  expect_equal(colnames(res), c("Probability of Type 1 Error","Probability of Type 2 Error","Power","Effect Size (Cohen's d)","Degree of Freedom","Required Sample Size"))
