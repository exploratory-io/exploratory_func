...
expect_equal(colnames(res),c("Group 1","Group 2","Difference","Conf High","Conf Low","Standard Error","DF","t Value","P Value","Method"))
res <- model_df %>% tidy_rowwise(model, type="pairs_per_variable")
expect_equal(colnames(res),c("Variable","Group 1","Group 2","Difference","Conf High","Conf Low","Standard Error","DF","t Value","P Value","Method"))
